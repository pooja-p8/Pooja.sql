...
insert into student values (93, 'riya', 'riya@gmail', '6546564645', 1);

-- Insert second student record 
insert into student values (92, 'harsha', 'harsha@gmail.com', 513248534, 2);

-- Insert values into course table
insert into course values (501, 'DBMS', 1), (502, 'circuits', 2);

-- Insert values into enrollment table
insert into enrollment values (91, 501, 3, 'A');

insert into enrollment values (92, 502, 3, 'B');
